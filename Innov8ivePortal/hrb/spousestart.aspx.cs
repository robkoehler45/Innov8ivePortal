...
{
    public partial class spousestart : System.Web.UI.Page
    {
        ...
        protected void sign_Click(object sender, EventArgs e)
        {
            ...
            {
                ReturnUrl = "https://innov8ive.app/hrb/professionalstart.aspx?eid=" + dsEnvelopeId + "&cid=" + dsCid,
                ClientUserId = dsCid,
                AuthenticationMethod = "email",
                UserName = "Robert Koehler",
                Email = "dssignerrob@gmail.com",
                AssertionId = "20823048908"
            };
